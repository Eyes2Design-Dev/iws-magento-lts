...
HTML
            ...
            'header_callout' => array(
                ...
                'status' => 1,
                'content' => <<<HTML
<img width="160" height="60" class="header-callout hidden-phone hidden-tablet" src="{{skin url="images/media/callout_customer_support.gif"}}" alt="Toll-Free Customer Support 24/7" style="margin: 5px 0 0 50px;"/>
HTML
            ),
            'scroll_up' => array(
                'title'      => 'scroll_up',
