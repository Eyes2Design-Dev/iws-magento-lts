...
<div class="col-home-set">
    ...
    <div class="col-main">
        <div class="col3-set">
            <div class="col-1">
                {{block type="highlight/product_special" name="homepage.special" title="Deal of the week" class_name="block block-alt" products_count="1" template="tm/highlight/product/grid.phtml"}}
            </div>
            <div class="col-2">
                {{block type="highlight/product_attribute_yesno" attribute_code="recommended" class_name="editor-choice  block block-alt" name="homepage.editor_choice" title="Editor choice" products_count="1" template="tm/highlight/product/grid.phtml"}}
            </div>
            <div class="col-3">
