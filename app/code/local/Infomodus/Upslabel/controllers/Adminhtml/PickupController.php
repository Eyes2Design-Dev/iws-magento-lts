    ...
    public function saveAction()
    {
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                $pickup->shipperCountryCode = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . Mage::getStoreConfig('upslabel/shipping/defaultshipper') . '/countrycode'));
                ...
                if(isset($data['oadress']['OtherAddress']) && $data['oadress']['OtherAddress']==1){
                    ...
                    $pickup->shipfromCompanyName = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . $data['ShipFrom'] . '/companyname'));
                    $pickup->shipfromAttentionName = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . $data['ShipFrom'] . '/attentionname'));
                    $pickup->shipfromAddressLine1 = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . $data['ShipFrom'] . '/addressline1'));
                    $pickup->room = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . $data['ShipFrom'] . '/room'));
                    $pickup->floor = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . $data['ShipFrom'] . '/floor'));
                    $pickup->shipfromCity = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . $data['ShipFrom'] . '/city'));
                    $pickup->shipfromStateProvinceCode = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . $data['ShipFrom'] . '/stateprovincecode'));
                    $pickup->urbanization = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . $data['ShipFrom'] . '/urbanization'));
                    $pickup->shipfromPostalCode = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . $data['ShipFrom'] . '/postalcode'));
                    $pickup->shipfromCountryCode = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . $data['ShipFrom'] . '/countrycode'));
                    $pickup->residential = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . $data['ShipFrom'] . '/residential'));
                    $pickup->pickup_point = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . $data['ShipFrom'] . '/pickup_point'));
                    $pickup->shipfromPhoneNumber = Infomodus_Upslabel_Helper_Help::escapeXML(Mage::getStoreConfig('upslabel/address_' . $data['ShipFrom'] . '/phonenumber'));
                }
