...
class Infomodus_Upslabel_Block_Adminhtml_Sales_Order_Grid extends Mage_Adminhtml_Block_Sales_Order_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('statustext', array(
            'header' => Mage::helper('upslabel')->__('UPS status'),
            'index' => 'statustext',
            'width' => '120px',
            'sortable' => false,
    ...
    protected function _orderUpsStatusFilter($collection, $column)
    {
        ...
        $collection->getSelect()->distinct(true)->join(array("t123" => Mage::getConfig()->getTablePrefix() . 'upslabel'), 't123.order_id = main_table.entity_id AND t123.type="shipment" AND t123.statustext="'.$value.'"', NULL);
