...
class Infomodus_Upslabel_Block_Adminhtml_Pickup_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $fieldset->addField('CloseTime', 'time', array(
          ...
          'required'  => true,
          'value'  => Mage::getStoreConfig('upslabel/pickup/CloseTime'),
      ));
      ...
      $fieldset->addField('ReadyTime', 'time', array(
          ...
          'required'  => true,
          'value'  => Mage::getStoreConfig('upslabel/pickup/ReadyTime'),
      ));
      ...
      $fieldset->addField('PickupDateYear', 'select', array(
          ...
          'required'  => true,
          'value'  => Mage::getStoreConfig('upslabel/pickup/PickupDateYear'),
      ...
      $fieldset->addField('PickupDateMonth', 'select', array(
          ...
          'required'  => true,
          'value'  => Mage::getStoreConfig('upslabel/pickup/PickupDateMonth'),
      ...
      $fieldset->addField('PickupDateDay', 'select', array(
          ...
          'required'  => true,
          'value'  => Mage::getStoreConfig('upslabel/pickup/PickupDateDay'),
      ...
      $fieldset->addField('AlternateAddressIndicator', 'select', array(
          ...
          'required'  => true,
          'value'  => Mage::getStoreConfig('upslabel/pickup/AlternateAddressIndicator'),
      ...
      $fieldset->addField('ServiceCode', 'select', array(
          ...
          'required'  => true,
          'value'  => Mage::getStoreConfig('upslabel/pickup/ServiceCode'),
      ...
      $fieldset->addField('Quantity', 'text', array(
          ...
          'required'  => true,
          'value'  => Mage::getStoreConfig('upslabel/pickup/Quantity'),
      ));
      ...
      $fieldset->addField('DestinationCountryCode', 'select', array(
          ...
          'required'  => true,
          'value'  => Mage::getStoreConfig('upslabel/pickup/DestinationCountryCode'),
      ...
      $fieldset->addField('ContainerCode', 'select', array(
          ...
          'required'  => true,
          'value'  => Mage::getStoreConfig('upslabel/pickup/ContainerCode'),
      ...
      $fieldset->addField('Weight', 'text', array(
          ...
          'value'  => Mage::getStoreConfig('upslabel/pickup/Weight'),
      ));
      ...
      $fieldset->addField('UnitOfMeasurement', 'select', array(
          ...
          'value'  => Mage::getStoreConfig('upslabel/pickup/UnitOfMeasurement'),
      ...
      $fieldset->addField('OverweightIndicator', 'select', array(
          ...
          'value'  => Mage::getStoreConfig('upslabel/pickup/OverweightIndicator'),
      ...
      $fieldset->addField('PaymentMethod', 'select', array(
          ...
          'required'  => true,
          'value'  => Mage::getStoreConfig('upslabel/pickup/PaymentMethod'),
      ...
      $fieldset->addField('SpecialInstruction', 'textarea', array(
          ...
          'value'  => Mage::getStoreConfig('upslabel/pickup/SpecialInstruction'),
      ));
      ...
      $fieldset->addField('ReferenceNumber', 'textarea', array(
          ...
          'value'  => Mage::getStoreConfig('upslabel/pickup/ReferenceNumber'),
      ));
      ...
      $fieldset->addField('Notification', 'select', array(
          ...
          'value'  => Mage::getStoreConfig('upslabel/pickup/Notification'),
      ...
      $fieldset->addField('ConfirmationEmailAddress', 'textarea', array(
          ...
          'value'  => Mage::getStoreConfig('upslabel/pickup/ConfirmationEmailAddress'),
      ));
      ...
      $fieldset->addField('UndeliverableEmailAddress', 'text', array(
          ...
          'value'  => Mage::getStoreConfig('upslabel/pickup/UndeliverableEmailAddress'),
      ));
      ...
      $fieldset->addField('ShipFrom', 'select', array(
          ...
          'required'  => true,
          'value'  => Mage::getStoreConfig('upslabel/shipping/defaultshipfrom'),
