...
/**
 * Txp_Express_Model_Base_Source_PaymentAction
 *
 * @category   TXP
...
class Txp_Express_Model_Base_Source_PaymentAction
{
    public function toOptionArray()
    {
        return array(
            array(
                'value' => Txp_Express_Model_Base::ACTION_AUTHORIZE,
                'label' => Mage::helper('Express')->__('Authorize now, Settle later.')
            ),
            array(
                'value' => Txp_Express_Model_Base::ACTION_AUTHORIZE_CAPTURE,
                'label' => Mage::helper('Express')->__('Authorize and Capture now.')
            ),
        );
    }
}
